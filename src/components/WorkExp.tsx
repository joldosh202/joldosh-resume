      ...
      <div>
         <div className='bg-gray-700 h-2'></div>
            <div className='bg-gray-800 h-[600px] w-full flex flex-col items-center text-white '>
               <div className='w-[360px] sm:w-[800px] mt-10 sm:mt-20' data-aos='fade-right'
                  data-aos-duration="3000">
                  <div className='text-center text-[30px] font-bold mb-10 font-montserrat'
                     
                     >work exprerience</div>
